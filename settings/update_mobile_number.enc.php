...
$page_url = file_location('home_url','settings/change_phonenumber/');
...
<body id="body"class="j-color4"style="font-family: Roboto,sans-serif;width: 100%;"onload="">
    <div class="j-row">
		...
		<div id="" class="j-col m10 l8 xl5">
			<?php $nav_bar="header";$header="Change Mobile Number";$back="back";require_once(file_location('inc_path','navigation.inc.php'));?>
            <div id='aud'class='j-padding'>
                <?php user_data('etpss','etmn')?>
			</div>
		</div>
